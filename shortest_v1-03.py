 ...
 #   print(path)
    ...
    while sp.gen_count<=sp.epoch_length:
      ...
      #  print("\n\nstoplist=\n",stoplist)
        ...
        fitness=fitness_calc(sp.genepool,dist)
...
##        genepool=mutate(genepool,mutation_rate)   # mutation rate is numbner of mutations per call
        ...
        distance=0   #round(vpath_distance(dpath),2)
      #  sp.genepool[i].insert(0,[distance,0.0])
        
        if distance<best_distance:
            best_distance=distance
            print("best=",best_distance,"gen=",sp.gen_count)
            best_best_list=stoplist
      ...
      #  alldist=vall_distance(sp.genepool,dist)
      #  print("alldist=\n",alldist)
...
##        genepool=mutate(genepool,mutation_rate)   # mutation rate is numbner of mutations per call
  ...
  #
  # display best
    draw_path(pygame,windowSurface,font,best_best_list,best_gen,best_distance,best_distance)
