...
################################
 ...
 #   print(monthno.shape)
    ...
    m_start=3
    n_steps = 35
    monthno_instance = np.arange(m_start, m_start+n_steps+1).ravel()
...
#################################    
 ...
 #       X_new = time_series(np.array(t_instance[:-1].reshape(-1, n_steps, n_inputs)))
      ...
      #  print("X_index=",X_index)
        X_new = sales[monthno_instance[:-1]].reshape(-1, n_steps, n_inputs)
  ...
  #  print("y_pred=",y_pred)
    ...
    plt.plot(monthno_instance[:-1], sales[monthno_instance[:-1]], "bo", markersize=10, label="instance")
    plt.plot(monthno_instance[1:], sales[monthno_instance[1:]], "w*", markersize=10, label="target")
  #  plt.plot(monthno_instance, sales[monthno_instance], "w*", markersize=10, label="target")

    plt.plot(monthno_instance[1:], y_pred[0,:,0], "r.", markersize=10, label="prediction")
    plt.legend(loc="best")
    plt.xlabel("Month")
...
##############################
    ...
    #    sequence = [10000.] * n_steps
        #sequence = monthno[-n_steps:].tolist()
        #nexts=sequence[-1]+1
  ...
  #  print("y_pred=\n",y_pred[0,:,0])    
    ...
    plt.plot(monthno[:lensales], sales[monthno[:lensales]], label=r"$unit sales$")
    plt.plot(monthno[:n_steps], sales[monthno[:n_steps]], linewidth=3, label=r"$unit sales$")
