...
sgd_lr = SGDClassifier(loss='log', penalty=None, fit_intercept=True, max_iter=5, learning_rate='constant', eta0=0.01)
...
X_dict_test, y_test_next10k = read_ad_click_data(1000, (i + 1) * 2000)
X_test_next10k = dict_one_hot_encoder.transform(X_dict_test)
