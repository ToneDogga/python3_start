...
payoff_filename="shoptrans2014to2019.csv"
       ...
       #print("returned payoff:",returned_payoff)
                        if direction=="x":
                            if returned_payoff>max_payoff:
                                ...
                                print("best fittest=",best," value=",int(best,2)," row number=",int(bestrow)," a=",axis[1]," b=",axis[2]," c=",axis[3]," d=",axis[4]," e=",axis[5]," f=",axis[6],"generation no:",gen,"max_payoff=",max_payoff,flush=True)
                                outfile.write("best fittest= "+best+" value= "+str(int(best,2))+" row number= "+str(int(bestrow))+" a="+str(axis[1])+" b="+str(axis[2])+" c="+str(axis[3])+" d="+str(axis[4])+" e="+str(axis[5])+" f="+str(axis[6])+" generation no: "+str(gen)+" max_payoff= "+str(max_payoff)+"\n")
                            ...
                            if returned_payoff<min_cost:
                                ...
                                print("best fittest=",best," value=",int(best,2)," row number=",int(bestrow)," a=",axis[1]," b=",axis[2]," c=",axis[3]," d=",axis[4]," e=",axis[5]," f=",axis[6],"generation no:",gen,"min_cost=",min_cost,flush=True)
                                outfile.write("best fittest="+best+" value="+str(int(best,2))+" row number="+str(int(bestrow))+" a="+str(axis[1])+" b="+str(axis[2])+" c="+str(axis[3])+" d="+str(axis[4])+" e="+str(axis[5])+" f="+str(axis[6])+" generation no: "+str(gen)+" min_cost= "+str(min_cost)+"\n")
