...
print("\n\nTurn a list of batches into a list of trained models - By Anthony Paech 25/2/20")
print("========================================================================")       
...
def plot_log_learning_curves(title,images_path,epochs,loss, val_loss,query_name):
    ax = plt.gca()
    ax.set_yscale('log')
    ...
    plt.ylabel("Log Loss")
    plt.grid(True)
    save_fig("log_learning_curve "+str(query_name),images_path)
    return
