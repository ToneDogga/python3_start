...
##
  ...
  #  salesreparray=dbd2.salesrep.to_numpy()
...
########################################################
  ...
  #  dbd2["salesrep"]=salesreparray.tolist()
...
#    dbd2["date"] = dbd2.date_encode.astype(int).map(dt.datetime.fromordinal)
    ...
    dbd2= dbd2[["date","code","salesrep","productgroup","product","qty","predict_qty"]]
...
##################################3
    ...
    df_pp= df_pp[["date","code","salesrep","productgroup","product","qty","predict_qty","predict_qty_ctnsof8"]]
...
#############################################################################3
  ...
  #  print("\ntable1=\n",table1.head(5))
    ...
    table1a = pd.pivot_table(dbd2, values='predict_qty_ctnsof8', index=['salesrep','productgroup'],columns=['code'], aggfunc=np.sum, margins=True, fill_value=0)
  # #  print("\ntable1=\n",table1.head(5))
    f.write("\n\n"+table1a.to_string())
  ...
  #  print("\ntable=\n",table.head(5))
    ...
    tablea = pd.pivot_table(dbd2, values='predict_qty', index=['salesrep','productgroup','product', 'date'],columns=['code'], aggfunc=np.sum, margins=True, fill_value=0)   #, observed=True)
  #  print("\ntable=\n",table.head(5))
    f.write("\n\n"+tablea.to_string())
  ...
  #  print("\ntable2=\n",table2.head(5))
    ...
    table2a = pd.pivot_table(dbd2, values='predict_qty', index=['salesrep','code', 'date'],columns=['productgroup','product'], aggfunc=np.sum, margins=True, fill_value=0)
  #  print("\ntable2=\n",table2.head(5))
    f.write("\n\n"+table2a.to_string())
  ...
  #  print("\ntable3=\n",table3.head(5))
    ...
    table3a = pd.pivot_table(dbd2, values='predict_qty', index=['salesrep','date',"code"],columns=['productgroup','product'], aggfunc=np.sum, margins=True, fill_value=0)
  #  print("\ntable3=\n",table3.head(5))
    f.write("\n\n"+table3a.to_string())
  ...
  #  print("\ntable4=\n",table4.head(5))
    ...
    table4a = pd.pivot_table(dbd2, values='predict_qty', index=['salesrep','date','productgroup',"product"],columns=['code'], aggfunc=np.sum, margins=True, fill_value=0)
  #  print("\ntable4=\n",table4.head(5))
    f.write("\n\n"+table4a.to_string())
  ...
  #  print("\ntable5=\n",table5.head(5))
    ...
    table5a = pd.pivot_table(dbd2, values='predict_qty_ctnsof8', index=['salesrep','productgroup','product', 'date'],columns=['code'], aggfunc=np.sum, margins=True, fill_value=0)
  #  print("\ntable5=\n",table5.head(5))
    f.write("\n\n"+table5a.to_string())
  ...
  #  print("\ntable6=\n",table6.head(5))
    ...
    table6a = pd.pivot_table(dbd2, values='predict_qty_ctnsof8', index=['salesrep','code', 'date'],columns=['productgroup','product'], aggfunc=np.sum, margins=True, fill_value=0)
  #  print("\ntable6=\n",table6.head(5))
    f.write("\n\n"+table6a.to_string())
  ...
  #  print("\ntable7=\n",table7.head(5))
    ...
    table7a = pd.pivot_table(dbd2, values='predict_qty_ctnsof8', index=['salesrep','date',"code"],columns=['productgroup','product'], aggfunc=np.sum, margins=True, fill_value=0)
  #  print("\ntable7=\n",table7.head(5))
    f.write("\n\n"+table7a.to_string())
  ...
  #  print("\ntable8=\n",table8.head(5))
    ...
    table8a = pd.pivot_table(dbd2, values='predict_qty_ctnsof8', index=['salesrep','date','productgroup',"product"],columns=['code'], aggfunc=np.sum, margins=True, fill_value=0)
  #  print("\ntable8=\n",table8.head(5))
    f.write("\n\n"+table8a.to_string())
  ...
  #  print("\ntable5=\n",table5.head(5))
    ...
    table9a = pd.pivot_table(dbd2, values='predict_qty_ctnsof8', index=['salesrep','productgroup','product'],columns=['code'], aggfunc=np.sum, margins=True, fill_value=0)
  #  print("\ntable5=\n",table5.head(5))
    f.write("\n\n"+table9a.to_string())
  ...
  #  print("\ntable6=\n",table6.head(5))
    ...
    table10a = pd.pivot_table(dbd2, values='predict_qty_ctnsof8', index=['salesrep','code'],columns=['productgroup','product'], aggfunc=np.sum, margins=True, fill_value=0)
  #  print("\ntable6=\n",table6.head(5))
    f.write("\n\n"+table10a.to_string())
  ...
  #  print("\ntable8=\n",table8.head(5))
    ...
    table11a = pd.pivot_table(dbd2, values='predict_qty_ctnsof8', index=['salesrep','product',"productgroup"],columns=['code'], aggfunc=np.sum, margins=True, fill_value=0)
  #  print("\ntable8=\n",table8.head(5))
    f.write("\n\n"+table11a.to_string())
  ...
  #  print("\ntable5=\n",table5.head(5))
    ...
    table12a = pd.pivot_table(dbd2, values='predict_qty_ctnsof8', index=['salesrep','product'],columns=['code'], aggfunc=np.sum, margins=True, fill_value=0)
  #  print("\ntable5=\n",table5.head(5))
    f.write("\n\n"+table12a.to_string())
    ...
    with pd.ExcelWriter(cfg.outxlsfile) as writer:  # mode="a" for append
        ...
        table1a.to_excel(writer,sheet_name="RepCtnsOfEight1")
        table5.to_excel(writer,sheet_name="CtnsOfEight5")
        table5a.to_excel(writer,sheet_name="RepCtnsOfEight5")
        table6.to_excel(writer,sheet_name="CtnsOfEight6")
        table6a.to_excel(writer,sheet_name="RepCtnsOfEight6")
        table7.to_excel(writer,sheet_name="CtnsOfEight7")
        table7a.to_excel(writer,sheet_name="RepCtnsOfEight7")
        table8.to_excel(writer,sheet_name="CtnsOfEight8")
        table8a.to_excel(writer,sheet_name="RepCtnsOfEight8")
        table9.to_excel(writer,sheet_name="CtnsOfEight9")
        table9a.to_excel(writer,sheet_name="RepCtnsOfEight9")
        table10.to_excel(writer,sheet_name="CtnsOfEight10")
        table10a.to_excel(writer,sheet_name="RepCtnsOfEight10")
        table11.to_excel(writer,sheet_name="CtnsOfEight11")
        table11a.to_excel(writer,sheet_name="RepCtnsOfEight11")
        table12.to_excel(writer,sheet_name="CtnsOfEight12")
        table12a.to_excel(writer,sheet_name="RepCtnsOfEight12")
        table.to_excel(writer,sheet_name="Units1")
        tablea.to_excel(writer,sheet_name="RepUnits1")
        table2.to_excel(writer,sheet_name="Units2")
        table2a.to_excel(writer,sheet_name="RepUnits2")
        table3.to_excel(writer,sheet_name="Units3")
        table3a.to_excel(writer,sheet_name="RepUnits3")
        table4.to_excel(writer,sheet_name="Units4")
        table4a.to_excel(writer,sheet_name="RepUnits4")
