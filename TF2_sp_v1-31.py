...
def main():
   ...
   # n_steps = 100
    ...
    batch_length=1096   #731   #731  #365  3 years of days
...
#    dates.sort()
 ...
 #   periods=set(list(df['period']))
   ...
   #     s_writer.writerow(product_names)
    ...
    print("\n\n",i*j,"lines written to prediction CSV.  Finished.")
