...
def draw_path(screen,font,ts,gencount,epoch_length,bestjourneyno,bestjourneydist):
  ...
  #  pygame.draw.line(screen, (255,0,255), (20,20), (70,80), 2)
    ...
    for i in range(0,len(ts.genepool[bestjourneyno])-1):
        ...
        screen.blit(font.render("Best gen:"+str(gencount)+"/"+str(epoch_length)+"="+str(bestjourneydist), True, (0,255,255)), (5, 5))  #, 2)
#        pygame.display.flip()
...
#screen = pygame.display.set_mode(size)
  ...
  #  WIDTH = 600
  #  HEIGHT = 600
    windowSurface = pygame.display.set_mode((ts.xsize, ts.ysize))   #, 0, 32)
 ...
 #       draw_path(windowSurface,ts,bestjourneyno)
...
#            draw_path(windowSurface,font,ts,gencount,epoch_length,bestjourneyno)
            draw_path(windowSurface,font,ts,gencount,epoch_length,bestjourneyno,bestjourneydist)
...
#  update graphical display
    ...
    #    draw_path(windowSurface,font,ts,gencount,epoch_length,bestjourneyno,bestjourneydist)
    #    windowSurface.blit(font.render("", True, (0,255,0)), (ts.xsize-200, 5))  #, 2)

        windowSurface.fill((0,0,0),rect=blitspace)
        
        blitspace=windowSurface.blit(font.render("Gen:"+str(gencount)+"/"+str(epoch_length), True, (0,255,0)), (ts.xsize-200, 5))  #, 2)
      #  time.sleep(1)
