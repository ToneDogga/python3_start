...
#size=2**length
#for r in range(1,20):
#xgene.find_a_payoff(0,payoff_filename)   #"/home/pi/Python_Lego_projects/payoff_1d.csv")
#xgene.find_a_payoff(3245,payoff_filename)   #"/home/pi/Python_Lego_projects/payoff_1d.csv")
#input("?")
