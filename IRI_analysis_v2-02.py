...
#    usable_measures=[0,4,5,8,9,10,11,12,13]
    len_usable_measures=len(cfg.usable_measures)

    measures_array=np.array(cfg.usable_measures).T.reshape(-1,1)
...
#    print("Plot work size=",plot_work_size,"\n")
    ...
    len_uniques=uniques.shape
    print("len uniques",len_uniques)
    plot_work_size=len(uniques)
    print("Plot work size=",plot_work_size,"\n")
