...
length=18   #16   # 16 length of dna bit strings
max_payoff=0
min_cost=0
...
total_rows=generate_payoff_environment_3d_file(0,1+2**6,0,1+2**6,0,1+2**6,payoff_filename)  
#size=2**length
#for r in range(1,20):
        ...
        if int(fittest,2)<=total_rows: 
            ...
            if direction=="x":
                if returned_payoff>max_payoff:
                    ...
                    print("best fittest=",best," value=",int(best,2)," row number=",axis[0]," x=",axis[1]," y=",axis[2]," z=",axis[3]," generation no:",gen," max_payoff=",max_payoff)
            elif direction=="n":
                if returned_payoff<min_cost:
                    ...
                    col=0
                    print("best fittest=",best," value=",int(best,2)," row number=",axis[0]," x=",axis[1]," y=",axis[2]," z=",axis[3]," generation no:",gen," min_cost=",min_cost)
            else:
