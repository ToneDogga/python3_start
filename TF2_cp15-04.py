...
print("forecasting several steps aheadf")
...
print("Now let's create an RNN that predicts all 10 next values at once:")
...
print("createing a custom RNN class")
