  ...
  #  print("\n\n")
    ...
    for prodrow in range(sales.shape[0]):
       ...
       # for prodrow in range(0,sales.shape[0]):
        ...
        plt.plot(weekno_instance[:-1], sales[prodrow,weekno_instance[:-1]], "b-", linewidth=3, label="A training instance")
     ...
     #   for prodrow in range(0,sales.shape[0]):
        plt.plot(weekno_instance[:-1], sales[prodrow,weekno_instance[:-1]], "bo", markersize=10, label="instance")
        plt.plot(weekno_instance[1:], sales[prodrow,weekno_instance[1:]], "w*", markersize=10, label="target")
        plt.legend(loc="best")
        plt.xlabel("Week")
...
#################################    
   ...
   # X_batch, y_batch = next_batch(sales,1, n_steps)
    ...
    n_iterations = 3000
    batch_size=n_outputs*n_steps/2
