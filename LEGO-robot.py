...
#  stage 3 is stage 2 that can see colours
# stage 4 is stage 3 where t can navigate across a pool table dodging balls.
# stage 5 is stage 4 where it is given a high level goal and it finds its way there
#
#
#!/usr/bin/env python
#
...
move_size=180  # global variable forwards or backwards move 
...
wait_time=1.5  # seconds to wait after a move
