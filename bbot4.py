...
#############################################
   #  key constants
    deadzone_minangle=-2  # plus or minus 2 degrees.  No speed adjustments in the deadzone
    deadzone_maxangle=-2
    tipped_over_angle=28  # plus or minus 20 degrees.  Kill the motor and let the robot stop
    perfect_angle=-2  # the angle the robot needs to be to balance.  The error angle is calculated from this
