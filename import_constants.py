...
batch_length=16  # one week=5 days   #4   #731   #731  #365  3 years of days  1096
y_length=1
neurons=800
start_point=100
...
mats=[16]    # series moving average window periods for each data column to add to series table
