...
bbtv_dict={
    "sales":{
        ...
        "save_dir":"./bbtv1_saves/",
        "output_dir":"./bbtv1_outputs/",
        "savefile":"salessavefile.pkl",
        "raw_savefile":"raw_savefile.pkl",
        "query_dict_savefile":"query_dict_savefile.pkl",
        "smoothing_mat":4,
        "annual_mat":52,
        "print_report":'AA_bbtv1_weekly_sales_snapshot.txt',
        "rename_columns_dict":{'specialpricecat':'spc','productgroup':'pg'},
        "apply_mask":True, #False, #True,
      #  "glset_not_spc_mask_flag":False, #True,
      #  "glset_only":["SHP","NAT","DFS","EXS","ADM","ONL","CON"],    
        "pg_only":["10","11","12","13","14","15","16","17"],   #,"18"]
        "spcs_only":['010','012','080','088','020',"028",'030',"038",'040',"048",'050','060','070',"122","107"],   #,"028"]   #,"038","048","028","080","020","030","040']
        "spc_only":[10,12,80,88,20,28,30,38,40,48,50,60,70,122,107],   #,"028"]   #,"038","048","028","080","020","030","040']
        "GSV_prod_codes_to_exclude":['PROMDEAL','OFFINV',"SCAN","DEMO","XDOCK","MERCHFEE","BADDEBT","SURCHARGE","FREIGHT","AIRFREIGHT","SEAFREIGHT","BANKFEES","EXPPROM","EXREBSATS","LABEL","ONLPROM"],
        "queries":{
          #  "Export all":[['AND',('glset','EXS')]],
          #  "Export retail only (pg=10,11,12,13,14)":[['AND',('glset','EXS')],['OR',("pg","10"),("pg","11"),("pg","12"),("pg","13"),("pg","14")]],
          #  "Export FS only (pg=1,2,5,41,42,43,31,36)":[['AND',('glset','EXS')],['OR',("pg","01"),("pg","02"),("pg","05"),("pg","041"),("pg","042"),("pg","043"),("pg","31"),("pg","36")]],
 
            
         #   "Woolworths (010) all":[['AND',('spc',10)]],         
         #   "HBCTRA":[['AND',('code','HBCTRA')]],
         #   "TARLING":[['AND',('code','TARLING')]],
         #  "Drakes table sauces 2019":[["BD",("date",pd.to_datetime("2019-01-01"),pd.to_datetime("2019-12-31"))],['AND',('sort','DR')],['AND',('pg','11')]],
         #   "Drakes table sauces 2020":[["BD",("date",pd.to_datetime("2020-01-01"),pd.to_datetime("2020-12-31"))],['AND',('sort','DR')],['AND',('pg','11')]],
            #  "Coles (012) condiments":[['AND',('spc',12)],['OR',("pg","13"),('pg','15'),('pg','16'),('pg','17')]],

      #     #  "Woolworths (010) jams":[['AND',('spc',10),("pg","10")]],
      #       "Woolworths (010) condiments":[['AND',("pg","13"),('spc',10)]],

      #     #  "Indies direct (028,038,048,088) all":[['OR',('spc',28),('spc',38),('spc',48),('spc',88)]],
      #      # "Indies direct (028,038,048,088) mealbases":[['OR',('spc',28),('spc',38),('spc',48),('spc',88)],['AND',("pg","14")]],  
      #      # "Indies direct (028,038,048,088) jams":[['OR',('spc',28),('spc',38),('spc',48),('spc',88)],['AND',("pg","10")]],           
      #       "Indies direct (028,038,048,088) condiments 13":[['OR',('spc',28),('spc',38),('spc',48),('spc',88)],['AND',("pg","13")]], 
      #       "Indies direct (028,038,048,088) condiments cheese 15":[['OR',('spc',28),('spc',38),('spc',48),('spc',88)],['AND',("pg","15")]], 
      #       "Indies direct (028,038,048,088) condiments trad 16":[['OR',('spc',28),('spc',38),('spc',48),('spc',88)],['AND',("pg","16")]],
      #       "Indies direct (028,038,048,088) condiments mustard 17":[['OR',('spc',28),('spc',38),('spc',48),('spc',88)],['AND',("pg","17")]],                      
      #       "Indies direct (028,038,048,088) sauces":[['OR',('spc',28),('spc',38),('spc',48),('spc',88)],['AND',("pg","11")]], 
      #       "Indies direct (028,038,048,088) dressings":[['OR',('spc',28),('spc',38),('spc',48),('spc',88)],['AND',("pg","12")]], 
             
      #   #    "NSW 020 all":[['AND',('spc',20)]],
      #       "NSW 020 mealbases":[['OR',('spc',20)],['AND',("pg","14")]],  
      #       "NSW 020 jams":[['OR',('spc',20)],['AND',("pg","10")]],           
      #       "NSW 020 condiments":[['AND',('spc',20)],['AND',("pg","13")]], 
      #       "NSW 020 condiments cheese 15":[['AND',('spc',20)],['AND',("pg","15")]], 
      #       "NSW 020 condiments trad 16":[['AND',('spc',20)],['AND',("pg","16")]], 
      #       "NSW 020 condiments mustard 17":[['AND',('spc',20)],['AND',("pg","17")]],                   
      #       "NSW 020 sauces":[['AND',('spc',20)],['AND',("pg","11")]], 
      #       "NSW 020 dressings":[['AND',('spc',20)],['AND',("pg","12")]], 


      #    #   "VIC 030 all":[['AND',('spc',30)]], 
      #       "VIC 030 mealbases":[['OR',('spc',30)],['AND',("pg","14")]],  
      #       "VIC 030 jams":[['OR',('spc',30)],['AND',("pg","10")]],           
      #       "VIC 030 condiments":[['AND',('spc',30)],['AND',("pg","13")]], 
      #       "VIC 030 condiments cheese 15":[['AND',('spc',30)],['AND',("pg","15")]], 
      #       "VIC 030 condiments trad 16":[['AND',('spc',30)],['AND',("pg","16")]], 
      #       "VIC 030 condiments mustard 17":[['AND',('spc',30)],['AND',("pg","17")]],                   
      #       "VIC 030 sauces":[['AND',('spc',30)],['AND',("pg","11")]], 
      #       "VIC 030 dressings":[['AND',('spc',30)],['AND',("pg","12")]], 


      #    #   "QLD 040 all":[['AND',('spc',40)]], 
      #       "QLD 040 mealbases":[['OR',('spc',40)],['AND',("pg","14")]],  
      #       "QLD 040 jams":[['OR',('spc',40)],['AND',("pg","10")]],           
      #       "QLD 040 condiments":[['AND',('spc',40)],['AND',("pg","13")]], 
      #       "QLD 040 condiments cheese 15":[['AND',('spc',40)],['AND',("pg","15")]], 
      #       "QLD 040 condiments trad 16":[['AND',('spc',40)],['AND',("pg","16")]], 
      #       "QLD 040 condiments mustard 17":[['AND',('spc',40)],['AND',("pg","17")]],                   
      #       "QLD 040 sauces":[['AND',('spc',40)],['AND',("pg","11")]], 
      #       "QLD 040 dressings":[['AND',('spc',40)],['AND',("pg","12")]], 

      # #      "080 SA all":[['AND',('spc',80)]],
            
      #     #  "WA 050 all":[['AND',('spc',50)]],
      #       "WA 050 mealbases":[['OR',('spc',50)],['AND',("pg","14")]],  
      #       "WA 050 jams":[['OR',('spc',50)],['AND',("pg","10")]],           
      #       "WA 050 condiments":[['AND',('spc',50)],['AND',("pg","13")]], 
      #       "WA 050 condiments cheese 15":[['AND',('spc',50)],['AND',("pg","15")]], 
      #       "WA 050 condiments trad 16":[['AND',('spc',50)],['AND',("pg","16")]], 
      #       "WA 050 condiments mustard 17":[['AND',('spc',50)],['AND',("pg","17")]],                              
      #       "WA 050 sauces":[['AND',('spc',50)],['AND',("pg","11")]], 
      #       "WA 050 dressings":[['AND',('spc',50)],['AND',("pg","12")]], 
...
# =========================================================================
        ...
        "plots":{
            ...
            "animation_plot_dump_dir":"animation_plot_dump_dir/",
            "animation_start_freeze_frames":60,
            "animation_end_freeze_frames":60,
            "animation_resize":(1360,800)
            },    
        "predictions":{
            "save_dir":"./bbtv1_saves/",
    ...
    "scan":{
      ...
      #  "scan_monthly_brand_include_mask":[1,2,3],
        ...
        "save_dir":"./bbtv1_saves/",
        "output_dir":"./bbtv1_outputs/",
        'brand_index_jam_save_input_file':"brand_index_jam_save_inputfile.pkl",
        'brand_index_chutney_save_input_file':"brand_index_chutney_save_inputfile.pkl"
    ...
    "production":{
        "save_dir":"./bbtv1_saves/",
        "production_df_savefile":"production_df_savefile.pkl",
        "SOH_savefile":"SOH_savefile.pkl",
        "PP_savefile":"PP_savefile.pkl",
        "PM_savefile":"PM_savefile.pkl",
        "extended_PM_savefile":"extended_PM_savefile.pkl",
        "extended_SOH_savefile":"extended_SOH_savefile.pkl",
        'joined_sales_and_stock_savefile':'joined_sales_and_stock_savefile.pkl',
        "products_to_plot_stock_levels":['SJ300','TS300',"TC260","CAR280"],
        "productgroups_to_plot_stock_levels":["10","11","12","13","14"],
    ...
    "scheduler":{
      ...
      #  'default_start_schedule_days_delay':10,
        "maximum_days_into_schedule_future":80,
        "min_day_size":50,  # number of batches in a day minimum
        "max_day_size":70,   # number of batches ina aday maximum
        "schedule_savefile":"schedule_savefile.pkl",
        "schedule_savedir":"./bbtv1_saves/",
        "schedule_save_excel":"schedule.xlsx",
        "schedule_savedir_plots":"./bbtv1_saves/plots/",
        "schedule_savedir_resized_plots":"./bbtv1saves/resized_plots/",
        "schedule_savefile_plots_gif":"recommended_schedule.gif",
        "schedule_savefile_plots_mp4":"schedule_options2.mp4",
    #    "schedule_plots_savedir":"./bbtv1_saves/plots/",
