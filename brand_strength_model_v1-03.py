...
######################################################################
   ...
   #sdsalestable= pd.pivot_table(X_df, values='sd_total_upspw', index=['day_delta'],columns=['sd_total_upspw'], aggfunc=np.sum, margins=True, fill_value=0)
    sdsales=X_df["sd_total_upspw"].mean()   
    print("SD sales upspw total mean=\n",sdsales)
    bmsales=X_df["bm_total_upspw"].mean()   
    print("BM sales upspw total mean=\n",bmsales)
    bbsales=X_df["bb_total_upspw"].mean()   
    print("BB sales upspw total mean=\n",bbsales)
    csales=X_df["c_total_upspw"].mean()   
    print("C sales upspw total mean=\n",csales)
...
############################################3
    ...
    X_total=X_df["bb_total_upspw"].to_numpy()  # regression
...
#####################################################################################333 
    ...
    dbe=pd.DataFrame(np.copy(X_df),columns=["sd_upspw_baseline","c_upspw_baseline","bm_upspw_baseline","bb_promo_disc","sd_promo_disc","c_promo_disc","bm_promo_disc","sd_total_upspw","c_total_upspw","bm_total_upspw","day_delta"])
    print(dbe.shape)
    dbe["date"]=X_date
    dbe["bb_upspw_baseline"]=X_baseline
    dbe["bb_total_upspw"]=X_total
    ...
    if sct_flag:
        ...
        scatter_matrix(dbe[["bb_total_upspw","sd_promo_disc","bm_promo_disc","c_promo_disc"]],alpha=0.2,figsize=(12,9))
        plt.show()


        scatter_matrix(dbe[["sd_total_upspw","bb_promo_disc","bm_promo_disc","c_promo_disc"]],alpha=0.2,figsize=(12,9))
        plt.show()


        scatter_matrix(dbe[["bm_total_upspw","bb_promo_disc","sd_promo_disc","c_promo_disc"]],alpha=0.2,figsize=(12,9))
        plt.show()


        scatter_matrix(dbe[["c_total_upspw","bb_promo_disc","sd_promo_disc","bm_promo_disc"]],alpha=0.2,figsize=(12,9))
        plt.show()



        scatter_matrix(dbe[["bb_total_upspw","sd_promo_disc"]],alpha=0.2,figsize=(12,9))
        plt.show()


        scatter_matrix(dbe[["bb_total_upspw","bm_promo_disc"]],alpha=0.2,figsize=(12,9))
        plt.show()


        scatter_matrix(dbe[["bb_total_upspw","c_promo_disc"]],alpha=0.2,figsize=(12,9))
        plt.show()


        scatter_matrix(dbe[["sd_total_upspw","bm_promo_disc"]],alpha=0.2,figsize=(12,9))
        plt.show()


        scatter_matrix(dbe[["sd_total_upspw","c_promo_disc"]],alpha=0.2,figsize=(12,9))
        plt.show()



        scatter_matrix(dbe[["bm_total_upspw","sd_promo_disc"]],alpha=0.2,figsize=(12,9))
        plt.show()


        scatter_matrix(dbe[["bm_total_upspw","c_promo_disc"]],alpha=0.2,figsize=(12,9))
        plt.show()


        scatter_matrix(dbe[["c_total_upspw","sd_promo_disc"]],alpha=0.2,figsize=(12,9))
        plt.show()


        scatter_matrix(dbe[["c_total_upspw","bm_promo_disc"]],alpha=0.2,figsize=(12,9))
        plt.show()
 ...
 #   worksheet = writer.sheets['report']
    ...
    while current_finish_date >= startdate and current_start_date >=startdate:
      ...
      #  print("dbg=\n",dbg)
        ...
        important_attributes=["date","bb_total_upspw","sd_total_upspw","bm_total_upspw","c_total_upspw","bb_promo_disc","sd_promo_disc","bm_promo_disc","c_promo_disc"]
