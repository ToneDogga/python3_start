...
# spin the mating wheel twice.
   ...
   #     print("mate1=",first_mate_index,"mate2=",second_mate_index)
    ...
    #    print("sp=",split_point,"new1=",child1,"new2=",child2)
        ...
        new_row1={"condition":child1,"message":message1,"match_flag":False,"bid":0.0,"ebid":0.0,"strength":new_strength,"specificity":0.0,"crowding":0.0,"payments":0.0, "taxes":0.0,"receipts":0.0,"winners":False,"brkdown":0.0,"address":"  ","keeping":False}
        newpopulation = newpopulation.append(new_row1, ignore_index=True)
        new_row2={"condition":child2,"message":message2,"match_flag":False,"bid":0.0,"ebid":0.0,"strength":new_strength,"specificity":0.0,"crowding":0.0,"payments":0.0, "taxes":0.0,"receipts":0.0,"winners":False,"brkdown":0.0,"address":"  ","keeping":False}
...
#
    params = dict(
       ...
       # input_file=sys.argv[1],
        ...
        starting_strength=2000.0,
        bidcoeff1=0.08,   # the % of the strength
        bidcoeff2=0.05,    #  added and adjusted by specificity of the genes ie the amountof '#'.  The total of the two should equal approx 0.12
        bidsigma=0.075,
        bidtax=0.01,
        lifetax=0.000,
        reward=1.0,    # 1.45 reward scaling factor from payment
        ...
        mutrate=51,  #[0,1,2],  every 50 cycles
        birthrate=6,  # 2 new conditions are born every ? cycles
        deathrate=3,  # an old unfit condition or duplicate is killed every ? cycles
        crowding_rate=1001,  # purge a number of similar genes to prevent crowding
