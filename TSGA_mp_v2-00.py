...
# q is the multiprocessing queue that the messages are sent back through
    ...
    print("Shortest path GA function started at PID:",os.getpid())
  ...
  #  print("genes=",ts.genepool)
    ...
    tsout.write("PID:"+str(os.getpid())+" Genetic algorithm. Started at: "+starttime+"\n\n\n")
    print("starting....")
     ...
     #   print("best=",bestdist[0])
       ...
       # print("genepool dist=",ts.totalgenepool_dist)
        ...
        if gencount==epoch_length:
            print("")
        print("\rPID:",os.getpid(),"Generation:",gencount," shortest distance:",round(bestjourneydist,2),end='\r',flush=True)
